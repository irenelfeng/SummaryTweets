...
filename=tf_idf.py
flag1=-text
arg1="We are elders of the Maasai from Tanzania, one of Africas oldest tribes. The government has just announced that it plans to kick thousands of our families off our lands so that wealthy tourists can use them to shoot lions and leopards. The evictions are to begin immediately.Last year, when word first leaked about this plan, almost one million Avaaz members rallied to our aid."
